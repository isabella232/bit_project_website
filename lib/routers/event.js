      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            query = {}; // TODO: Link search bar button to actually retrive it upon searching

            _context3.prev = 1;
            console.log(req.query); // const event = await Event.findOne({eventName:"Turkey Trot"})
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 6:
            // if found send user
            res.send(event); //send 500 error if error
